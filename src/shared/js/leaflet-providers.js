  ...
  L.TileLayer.Provider.providers = {
    ...
    OneMapSG: {
      ...
      options: {
        ...
        attribution:
          '<img src="https://docs.onemap.sg/maps/images/oneMap64-01.png" alt="" style="height:20px;width:20px;"/> New OneMap | Map data &copy; contributors, <a href="http://SLA.gov.sg">Singapore Land Authority</a>',
      },
      variants: {
        Default: 'Default',
        Night: 'Night',
